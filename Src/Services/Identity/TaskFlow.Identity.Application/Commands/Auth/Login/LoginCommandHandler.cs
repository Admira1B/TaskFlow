...
namespace TaskFlow.Identity.Application.Commands.Auth.Login {
    public class LoginCommandHandler(IMapper mapper, UserManager<Domain.Entities.User> userManager, SignInManager<Domain.Entities.User> signInManager, JsonWebTokenService jwtService) : IRequestHandler<LoginCommand, AuthResult> {
